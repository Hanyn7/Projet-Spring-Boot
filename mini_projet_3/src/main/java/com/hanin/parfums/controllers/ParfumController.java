...
public String showCreate(ModelMap modelMap)
{
	...
	prod.setFamille(cat); //affedter une catégorie par défaut au produit pour éviter le pb avec une catégorie null
...
public String saveParfum(@Valid Parfum parfum,
    ...
    int totalPages = parfumService.getAllParfumsParPage(0, size).getTotalPages();
